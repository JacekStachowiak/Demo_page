...
class TestUpdateAddress:
    ...
    def test_update_address(self):
        ...
        my_account_pages.log_in(email, 'testeroprogramowania')
        ...
        address_page.set_address('Dworcowa 2', '66-550', 'Kraków')
        address_page.set_phone_number('444 555 777')
        address_page.save_button()
